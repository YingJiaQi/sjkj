							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-sm-4">
								    	...
								    	<div id="parentLeafNode" class="easyui-menu">
								    		<ul class="nav nav-list">
								    			<li>
											        <a href="#"  onclick="addNode()" ><i class=" icon-plus"></i><span class="menu-text"> 添加节点 </span></a>
								    			</li>
								    			<li>
											        <a href="#"  onclick="removeNoded()" ><i class="icon-remove"></i><span class="menu-text"> 删除节点</span></a>
								    			</li>
								    			<li>
											        <a href="#"  onclick="updateNode()" ><i class=" icon-pencil"></i><span class="menu-text">修改节点 </span></a>
								    			</li>
								    		</ul>
								    	</div>
									</div>
...
<![endif]-->
		...
		<script src="../static/js/pages/bs_specificationParamManager.js"></script>
