			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'userCode',index:'userCode', width:70, editable: false},
						{name:'userName',index:'userName',width:70, editable:true,editoptions:{size:"20",maxlength:"50"}},
						...
						{name:'isActive',index:'isActive', width:80, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch,formatter:reverseActive},
