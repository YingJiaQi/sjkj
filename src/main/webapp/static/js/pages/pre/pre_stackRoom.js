					...
					var html = " <div class='col-xs-6 col-sm-4 col-md-2'> "+
					        " <div class='thumbnail'>  "+
					        	"<a href='javascript:void(0)' onclick='showBookDetail(this)' urls='"+data.newList[i].bookUrl+"'>  "+
						            "<img src='http://47.95.208.48:8088"+data.newList[i].picUrl+"' alt='"+data.newList[i].bookName+"' height='220px' class='img-rounded'>  "+
					...
					var html = " <div class='col-xs-6 col-sm-4 col-md-2'> "+
					        " <div class='thumbnail'>  "+
					        	"<a href='javascript:void(0)' onclick='showBookDetail(this)' urls='"+data.cxList[i].bookUrl+"'>  "+
						            "<img src='http://47.95.208.48:8088"+data.cxList[i].picUrl+"' alt='"+data.cxList[i].bookName+"'  height='220px'  class='img-rounded'>  "+
					...
					var html = " <div class='col-xs-6 col-sm-4 col-md-2'> "+
					        " <div class='thumbnail'>  "+
					        	"<a href='javascript:void(0)' onclick='showBookDetail(this)' urls='"+data.hpList[i].bookUrl+"'>  "+
						            "<img src='http://47.95.208.48:8088"+data.hpList[i].picUrl+"' alt='"+data.hpList[i].bookName+"'  height='220px'  class='img-rounded'>  "+
					...
					var html = " <div class='col-xs-6 col-sm-4 col-md-2'> "+
					        " <div class='thumbnail'>  "+
					        	"<a href='javascript:void(0)' onclick='showBookDetail(this)' urls='"+data.scList[i].bookUrl+"'>  "+
						            "<img src='http://47.95.208.48:8088"+data.scList[i].picUrl+"' alt='"+data.scList[i].bookName+"'  height='220px'  class='img-rounded'>  "+
